...
- [If-Else Statements in Verilog](#if-else-statements-in-verilog)
- [Inferred Latches in Verilog](#inferred-latches-in-verilog)
- [Labs for If-Else and Case Statements](#labs-for-if-else-and-case-statements)
